...
for bar in bars:
    yval = bar.get_height()
    plt.text(bar.get_x() + bar.get_width()/2, yval + 0.1, round(yval,2), ha='center', fontsize=12)
#%%
#classify labels
#This is subjective and data driven
da['class_res']='Low'
da['class_res'][da['Cluster']>0]='High'
#%%
...
for ii in df_res.columns:
    gdf[ii]=df_res[ii]
gdf.to_file(r'RS_KM_Calgary_RP=%d_v2.shp'%(RP[0]))